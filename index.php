            ...
            <div id="scrollbar2" class="art-scroll-frame">
              ...
              <div class="art-table p-15-15">
                ...
                <ul>
                  <!-- country -->
                  <li>
                    <h6>Residence:</h6><span>UKRAINE</span>
                  </li>
                  <!-- city -->
                  <li>
                    <h6>City:</h6><span>Lviv</span>
                  </li>
                  <!-- age -->
                  <li>
          ...
          <div class="transition-fade" id="swup">
            ...
            <div id="scrollbar" class="art-scroll-frame">
                      ...
                      <div class="art-banner-overlay">
                        ...
                        <div class="art-banner-title">
                          ...
                          <div class="art-buttons-frame">
                            ...
                            <!-- button -->
                            <a href="https://www.linkedin.com/in/vladimir-krizhovets-7677781a3/" class="art-link art-white-link art-w-chevron">Hire me</a>
                          </div>
                        </div>
                        <!-- main title end -->
                        <!-- photo -->
                  ...
                  <div class="col-lg-4 col-md-6">
                    ...
                    <div class="art-a art-service-icon-box">
                      ...
                      <div class="art-service-ib-content">
                        ...
                        <!-- button -->
                        <div class="art-buttons-frame"><a href="https://www.linkedin.com/in/vladimir-krizhovets-7677781a3/" class="art-link art-color-link art-w-chevron">Order now</a></div>
                      </div>
                      <!-- service content end -->
                    </div>
                    <!-- service end -->
                    ...
                    <div class="art-a art-price">
                      ...
                      <div class="art-price-body">
                        ...
                        <ul class="art-price-list">
                          ...
                          <li>Windows Help</li>
                          <!-- list item -->
                          <li class="art-empty-item">AWS</li>
                          <!-- list item -->
                          <li class="art-empty-item">Jenkins</li>
                          <!-- list item -->
                          <li class="art-empty-item">Ansible</li>
                        </ul>
                        <!-- price list end -->
                        <!-- button -->
                        <a href="https://www.linkedin.com/in/vladimir-krizhovets-7677781a3/" class="art-link art-color-link art-w-chevron">Order now</a>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-card">
                      <div class="art-table p-15-15">
                        <ul>
                          <li>
                            <h6>Country:</h6><span>Ukraine</span>
                          </li>
                          <li>
                            <h6>City:</h6><span>Lviv</span>
                          </li>
                          ...
                          <li>
                            <h6>Streat:</h6><span>Zelena st.</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-card">
                      <div class="art-table p-15-15">
                        <ul>
                          <li>
                            <h6>Email:</h6><span>krizhovets@gmail.com</span>
                          </li>
                          <li>
                            <h6>Telegram:</h6><span>@zrz</span>
                          </li>
                          <li>
                            <h6>Skype:</h6><span>krizhovetz</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="art-a art-card">
                      <div class="art-table p-15-15">
                        <ul>
                          <li>
                            <h6>Support service:</h6><span>+38 (098) 219 52 56</span>
                          </li>
                          <li>
                            <h6>Office:</h6><span>+38 (098) 219 52 56</span>
                          </li>
                          <li>
                            <h6>Personal:</h6><span>+38 (098) 219 52 56</span>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div class="container-fluid">
                ...
                <footer>
                  <!-- copyright -->
                  <div>© 2022 Volodymyr Kryzhovets</div>
